...
Our first real-world deployment: 10 sensors on e-scooters in London, gathering over a million air quality readings
{.banner}
...
<img src="/images/Scooters_lines_up_in_Depot.jpg" alt="Photo of 10 e-scooters with sensors attached, lined up in Voi depot" class="my-2">
...
<img src="/images/three_plot_output.png" alt="Figure showing three pollution heat maps (for NO2, CO and PM2.5) that were recorded during the deployment" class="my-2">
...
The data is now being analysed by the Local Air team. [Find out more about what it is telling us](data.md).
...
<img src="/images/Sam_in_fishpoinds_depot.png" alt="Photo of Sam with one of the Voi depot staff" class="d-block my-2 mx-auto" style="max-width: 50%">
